...
namespace MRSA
{
    public partial class Form1 : Form
    {
        ...
        /// <summary>
        /// Дает информацию о том, как пользоваться программой
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        ...
        {
            MessageBox.Show(
            "Кликом мышки можно рисовать точки\nДля генерации точек -> Генерация\nОткрытие файла формата /tsp -> Открыть\nДля запуска работы алгоритма -> Старт/Продолжить\nПриостановить работу алгоритма -> Пауза\nСохранить информацию о работе алгоритма -> Сохранить\nОчистить поле -> Очистить",
            "Информация",
            MessageBoxButtons.OK,
            MessageBoxIcon.Information,
            MessageBoxDefaultButton.Button1);
        ...
        /// <summary>
        /// Дает общую информацию о программе
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        ...
        {
            MessageBox.Show(
            "Программа для построения прямолинейного дерева Штейнера\nна основе генетического алгоритма\n\nВыполнил: Сорокин Иван, студент 1 курса, группа БПИ161\nНаучный руководитель: Авдошин Сергей Михайлович",
            "Информация",
            MessageBoxButtons.OK,
            MessageBoxIcon.Information,
            MessageBoxDefaultButton.Button1);
